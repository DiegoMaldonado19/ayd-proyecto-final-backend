...
public interface JpaSubscriptionRepository extends JpaRepository<SubscriptionEntity, Long> {
        ...
        /**
         * Buscar suscripción activa por placa con fecha actual
         */
        default Optional<SubscriptionEntity> findActiveLicensePlateSubscription(String licensePlate) {
                return findActiveLicensePlate(licensePlate, LocalDateTime.now());
        }
