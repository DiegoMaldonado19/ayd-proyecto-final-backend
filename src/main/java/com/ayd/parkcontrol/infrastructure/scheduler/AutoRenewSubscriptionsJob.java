 ...
 * 
 * Regla de Negocio: Las suscripciones con auto_renew_enabled=true se renuevan automáticamente
 * 7 días antes de su vencimiento. Se notifica al usuario por email del resultado.
 * 
...
public class AutoRenewSubscriptionsJob {
    ...
    private String buildSuccessEmailBody(Subscription subscription) {
        return String.format("""
                ...
                subscription.getPlan() != null ? subscription.getPlan().getPlanTypeName() : "Plan ID: " + subscription.getPlanId(),
