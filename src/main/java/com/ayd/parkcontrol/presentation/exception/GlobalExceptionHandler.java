...
public class GlobalExceptionHandler {
        ...
        public ResponseEntity<ErrorResponse> handleDuplicateBranchNameException(DuplicateBranchNameException ex,
                        WebRequest request) {
                log.error("Duplicate branch name: {}", ex.getMessage());
                ErrorResponse error = ErrorResponse.builder()
                                .status(HttpStatus.CONFLICT.value())
                                .error("Conflict")
                                .message(ex.getMessage())
        ...
        public ResponseEntity<ErrorResponse> handleSubscriptionPlanNotFoundException(
                        ...
                        WebRequest request) {
                log.error("Subscription plan not found: {}", ex.getMessage());
                ErrorResponse error = ErrorResponse.builder()
                                .status(HttpStatus.NOT_FOUND.value())
                                .error("Not Found")
                                .message(ex.getMessage())
        ...
        @ExceptionHandler(DuplicatePlanTypeException.class)
        public ResponseEntity<ErrorResponse> handleDuplicatePlanTypeException(DuplicatePlanTypeException ex,
                        WebRequest request) {
                log.error("Duplicate plan type: {}", ex.getMessage());
                ErrorResponse error = ErrorResponse.builder()
                                .status(HttpStatus.CONFLICT.value())
                                .error("Conflict")
                                .message(ex.getMessage())
        ...
        @ExceptionHandler(InvalidDiscountHierarchyException.class)
        public ResponseEntity<ErrorResponse> handleInvalidDiscountHierarchyException(
                        InvalidDiscountHierarchyException ex,
                        WebRequest request) {
                log.error("Invalid discount hierarchy: {}", ex.getMessage());
                ErrorResponse error = ErrorResponse.builder()
